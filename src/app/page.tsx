...
import imgSalesMan from "../../public/images/sales-man.png";
...
export default function Home() {
  const fonteTexto =
    "p-2 font-sans text-lg dark:text-gray-200 text-gray-600 sm:text-sm md:text-lg lg:text-lg lg:text-wrap sm:text-wrap";
  return (
    <div className="container sm:max-w-screen mx-auto bg-neutral-950 dark:bg-neutral-900">
      ...
      >
        <div className="flex w-full justify-center mt-1 p-1 shadow-2xl shadow-cyan-300 bg-background overflow-hidden">
          <VideoCarousel />
        </div>
      </div>
            ...
            <div className="flex flex-col items-center mb-3 p-2 shadow-2xl shadow-cyan-300">
              ...
              <div className="flex flex-col gap-y-2 w-full justify-center mt-1 lg:gap-x-2 shadow-xl shadow-cyan-300 bg-background">
                <div className="flex flex-col min-h-auto overflow-hidden bg-gray-950 object-cover p-1">
                  ...
                  >
                    Administre o desempenho da sua equipe de forma EFICIENTE,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
              ...
              <div>
                <div className="rounded overflow-hidden shadow-2xl shadow-cyan-300 bg-background h-full w-auto">
                  ...
                  />
                  <p className={`${fonteTexto} text-sm p-1`}>
                    Evolução de vendas diárias contrastando com a meta de
                    vendas.
                  </p>
                </div>
              </div>
      ...
      <div
        id="segmentos"
        className="bg-slate-50 w-full justify-center items-center"
      ></div>
