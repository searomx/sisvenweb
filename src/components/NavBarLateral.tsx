		...
		<div className={style.sidenav} >
			<nav>
				<ul className="flex flex-col justify-between gap-2" id="navbar">
					...
					<li className="border-gray-200 dark:border-gray-700 px-2 py-2 text-sm text-gray-600 dark:text-gray-400 cursor-pointer">
						<Link to="gestao" smooth={true} duration={500} className="hover:text-gray-900 text-gray-600">
							Painéis de Gestão
						</Link>
					</li>
					<li className="border-gray-200 dark:border-gray-700 px-2 py-2 text-sm text-gray-600 dark:text-gray-400 cursor-pointer">
						<Link to="segmentos" smooth={true} duration={500} className="hover:text-gray-900 text-gray-600">
							Segmentos
						</Link>
					</li>
				</ul>
