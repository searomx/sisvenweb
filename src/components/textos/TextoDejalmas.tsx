  ...
  return (
    <>
      <p className="dark:text-white text-gray-900 text-start sm:text-sm md:text-lg lg:text-lg lg:text-wrap sm:text-wrap">
        ...
        nossos processos comerciais, acompanhar o desempenho da equipe e
        entender com clareza os números do nosso negócio. O SGV chegou como uma
